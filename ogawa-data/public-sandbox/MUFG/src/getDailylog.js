...
define(['N/sftp', 'N/log', 'N/file', 'N/record'], function (sftp, log, file, record) {
    ...
    function downloadFile(targetStr) {
        ...
        var fileName;
        var prefix = "%BTMUGP01LIV%BTMUTPF7LIV%BOTK";
        var subfix = "%POLLABLE%";
