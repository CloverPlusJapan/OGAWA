    ...
    function (
        ...
        function sendMUFG(id, type) {
            ...
            if (skipFlag === true) {
                ...
                // 7. Update record
                if (errorFlag === false) {
                    targetRecord.setValue({ fieldId: 'custbody_mufg_status', value: 1 }); // mufg status as processed
                } else { // if there is any error to catch
                    targetRecord.setValue({ fieldId: 'custbody_mufg_status', value: 1 }); // mufg status as error
                    targetRecord.setValue({ fieldId: 'approved', value: false }); // revert approval
                }
                targetRecord.save()
            }
        }
        ...
        function editRecordObjJE(recordObj, inputObj) {
            ...
            inputObj.PmtId = recordObj.getValue({ fieldId: 'tranid' });
        ...
        function cnvrtMUFGacct(objSrc) {
            ...
            if (objSrc.Ccy !== objSrc.CcyHeader){
              ...
              objSrc.Amount = calcAmount.toFixed(2);
            }
            return objSrc
        }
        function sftpUpload(fileObj, upDir) {
            ...
            try {
                ...
                var strUrl = "psftp-btmu2.ms.gxs.com";
                var strUsername = "BTMUTPF7LIV";
                var numPort = 22;
                ...
                var connection = sftp.createConnection({
                    ...
                    port: numPort,
                    directory: '/BTMUTPF7LIV/BTMUGP01LIV/',
                });
